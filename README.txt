...
Non-conflicting Mods***:
	...
	HomesteadButter
	Homestead Magic Water - Basic Staples does NOT have a Magic Water recipe.
	HoneyGlazedChips
	HoneyGlazedCarrots
	MoreHoney
	Pearl_Jam
	KK's Pizza
	StarJelly - Basic Staples does NOT have a Star Jelly recipe.
	StaxelCookieDough
		* Not useable in place of Staple's Cookie Dough because the game hates my attempts to make that happen.
	Waifu Bartending
